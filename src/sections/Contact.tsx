    ...
    emailjs
      .send(
        ...
        "template_vb088mp", // Replace with your EmailJS Template ID
        {
          ...
          to_email: "amitk200415@gmail.com",
        },
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <motion.input
                    ...
                    required
                    className="mt-1 text-black block w-full px-4 py-2 bg-gray-50 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none transition-all"
